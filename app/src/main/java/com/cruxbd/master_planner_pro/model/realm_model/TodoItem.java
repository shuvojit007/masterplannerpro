...
public class TodoItem extends RealmObject implements Parcelable {
    ...
    public TodoItem(String id, String userId, String task, String note, Date dueDate, Date remindDate, Boolean repeatEnabled, String repeatType, int alarm_req_code, boolean alarm_status, int repeatCustom, String list, int priority, boolean locked, String locationName, Double lat, Double lng, Boolean done, Boolean deleted, Boolean hasCountdown, CountdownModel countdown, Date createdAt) {
        this.id = id;
        this.userId = userId;
        this.task = task;
        this.note = note;
